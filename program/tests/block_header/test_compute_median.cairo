...
// protostar test --cairo-path=./src target tests/block_header/*_median.cairo
//
%lang starknet

from starkware.cairo.common.alloc import alloc
from block_header.median import compute_timestamps_median, verify_timestamps_median
