...
// protostar test  --cairo-path=./src target tests/block_header/*_bits_and_target*
//

%lang starknet

from block_header.block_header import bits_to_target, target_to_bits
...
func test_encode_decode{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}() {
    ...
    %{
        # Read JSON file
        import json
        io = open('program/tests/block_header/test_bits_and_target.json')
